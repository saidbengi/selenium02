...
public class C02_BestBuyAssertions {
    ...
    public void test01() {
        ...
        Assert.assertEquals("Ayni mi??", actualUrl, expectedUrl);
    }
    ...
    public void test04(){
        // ○ FrancaisLinkTest => Fransizca Linkin görüntülendiğini test edin
        WebElement dilButton=driver.findElement(By.xpath("(//button[@lang='fr'])"));
        Assert.assertTrue(dilButton.isDisplayed());
    }
}
